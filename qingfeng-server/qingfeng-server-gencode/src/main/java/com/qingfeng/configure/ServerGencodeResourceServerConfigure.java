...
/**
 * @ProjectName ServerGencodeResourceServerConfigure
 * @author qingfeng
 * @version 1.0.0
 * @Description TODO
...
public class ServerGencodeResourceServerConfigure extends ResourceServerConfigurerAdapter {
    ...
    @Autowired
    private ServerGencodeProperties properties;
