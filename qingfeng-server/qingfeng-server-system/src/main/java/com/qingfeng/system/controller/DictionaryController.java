...
public class DictionaryController extends BaseController {
    ...
    public void save(@Valid @RequestBody Dictionary dictionary) throws MyException {
        try {
            // 创建用户
    ...
    public void update(@Valid @RequestBody Dictionary dictionary) throws MyException {
        try {
            // 更新组织信息
            String time = DateTimeUtil.getDateTimeStr();
            String authParams = SecurityContextHolder.getContext().getAuthentication().getName();
    ...
    public void updateStatus(@Valid @RequestBody Dictionary dictionary) throws MyException {
        try {
            this.dictionaryService.updateById(dictionary);
        } catch (Exception e) {
